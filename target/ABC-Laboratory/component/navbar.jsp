...
<nav class="navbar navbar-expand-lg navbar-dark"style="background-color: #4568dc;">
	<div class="container-fluid">
		<a class="navbar-brand" href="index.jsp"><i class="fa-sharp fa-solid fa-hospital"></i> ABC LAB</a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<c:if test="${empty userObj}">
					...
					<li class="nav-item"><a class="nav-link active"
											aria-current="page" href="technicians_login.jsp">
						<i class="fas fa-sign-in-alt"></i> TECHNICIAN</a></li>
					<li class="nav-item"><a class="nav-link active"
